...
Block.getBlockValue = function getBlockValue(height) {
  var subsidy;
    if (height > 0 && height < 50001) { subsidy = (5000 * 100000000);
    } else if (height > 50000 && height < 100001) { subsidy = 2500 * 100000000);
    } else if (height > 100000 && height < 150001) { subsidy = 1250 * 100000000);
    } else if (height > 150000 && height < 200001) { subsidy = 625 * 100000000);
    } else if (height > 200000 && height < 250001) { subsidy = 312 * 100000000);
    } else if (height > 250000 && height < 350001) { subsidy = 156 * 100000000);
    } else if (height > 400001) { subsidy = 100 * 100000000);
    };
  return subsidy;
};
